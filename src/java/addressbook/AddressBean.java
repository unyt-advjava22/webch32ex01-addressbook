...
@DataSourceDefinition(
   ...
   url = "jdbc:derby://localhost:1527/advjava19-addressbook",
   databaseName = "advjava19-addressbook",
   user = "APP",
   password = "app")
*/
...
{    
   ...
   @Resource(lookup = "jdbc/addressbook")
      ...
      try
      {
         ...
         PreparedStatement addEntry = 
            connection.prepareStatement("INSERT INTO ADDRESSES " +
               "(FIRSTNAME,LASTNAME,STREET,CITY,STATE,ZIP,EMAIL,PHONENUMBER)" +
               " VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
         ...
         addEntry.setString(7, getEmail());
         addEntry.setString(8, getPhoneNumber());
